          ...
          {memberships.map((membership) => (
            <div key={membership._id} className="card bg-base-100 shadow-sm">
              <figure className="h-32 overflow-hidden">
                <img
                  src={
                    ...
                    `https://placehold.co/400x200/2563eb/ffffff?text=${encodeURIComponent(
                      membership.club?.clubName || "Club"
                    )}`
                  }
              ...
              <div className="card-body p-4">
                ...
                <Link
                  to={`/clubs/${membership.club?._id}`}
                  className="btn bg-[#38909D] text-white hover:bg-[#F6851F] btn-sm mt-2"
                >
                  View Club
                </Link>
              </div>
