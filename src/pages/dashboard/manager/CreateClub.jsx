  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold text-[#38909D] mb-6">
        Create New<span className="text-[#F6851F]"> Club</span>
      </h1>
        ...
        <div className="card-body">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="form-control">
              ...
              <label className="label">
                <span className="label-text-alt">
                  Leave 0 or empty for free membership
                </span>
              </label>
            </div>
            ...
            <div className="alert alert-info bg-[#ac6905] text-white">
              <span>
                Your club will be reviewed by an admin before it becomes visible
                to the public.
              </span>
            </div>
            ...
            <button
              type="submit"
              className="btn bg-[#38909D] w-full text-white hover:bg-[#F6851F]"
