        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-base-content/70 max-w-md">
              Connect with local clubs, manage memberships, and discover exciting events in your community. Join the
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-circle">
                <FaXTwitter size={20} />
              </a>
            </div>
          </div>
