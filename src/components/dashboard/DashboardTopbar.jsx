    ...
    <header className="bg-base-100 shadow-sm sticky top-0 z-30">
      <div className="px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleLogout} className="btn btn-ghost btn-sm gap-2 hover:text-black">
            <FiLogOut size={18} className="text-[#F6851F] " />
            <span className="hidden text-[#38909D]  sm:inline">
              Logout
            </span>
          </button>
        </div>
